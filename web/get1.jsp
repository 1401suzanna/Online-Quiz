...
PreparedStatement ps=con.prepareStatement("select answer from quizques where cid='"+name+"' and qid='"+count1+"' ");
...
PreparedStatement ps=con.prepareStatement("select answer from quizques where cid='"+name+"' and qid='"+max+"' ");
ResultSet rs=ps.executeQuery();
if(rs.next()){
String ans1=rs.getString(1);
