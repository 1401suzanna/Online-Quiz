...
if(count==0){
PreparedStatement ps1= con.prepareStatement("select min(qid) from quizques where cid='"+name+"'");
PreparedStatement ps2= con.prepareStatement("select max(qid) from quizques where cid='"+name+"'");
...
if(count>0){
PreparedStatement ps=con.prepareStatement("select * from quizques where cid='"+name+"' and qid='"+count+"' ");
