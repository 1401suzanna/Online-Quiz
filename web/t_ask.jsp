...
PreparedStatement ps2= con.prepareStatement("select query,reply from feedback where cid='"+name+"' and query='"+query+"'");
...
<ul>
   ...
   <li><a href='t_ask2.jsp'><span>view Feedback</span></a></li>
   ...
   <li class='letter'><a>Hello, <%= session.getAttribute( "username" ) %> (<%= session.getAttribute( "category" ) %>) </a></li>
                  ...
                  <div id="contact_form">
                   ...
                   <h1 class="contact_h1">Ask Questions </h1>
                       ...
                       <form method="post" action="t_feedbackprocess.jsp" name="myform">
                    ...
                    <label class="label2" style="width: 300px;font-size: 15px; float:left;  margin-right: 15px;"><%
                     ...
                     <div class="form_row">
                    <label  class="label"> reply:</label><input name="reply" class="contact_input" type="text">
                    </div>                   
                    
                    
                       <div class="form_row">
                           <input type="submit" class="read_more" value="post reply"/>    </div>  
					</form>        
